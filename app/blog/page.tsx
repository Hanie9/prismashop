  ...
  return (
    <div className="min-h-screen bg-[#faf6ee]">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-black text-[#2e1a08] mb-3">بلاگ پریسما شاپ</h1>
        <p className="text-[#6d4014] mb-8">آموزش‌ها، راهنماها و ایده‌های کاربردی برای کارهای چوبی و کالیگرافی.</p>
              ...
              <article key={post.slug} className="bg-white border border-[#e8cfa8] rounded-2xl overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-[#a96c20]">{post.date}</span>
